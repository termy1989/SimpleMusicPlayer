...
class MusicListActivity : AppCompatActivity(),
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (item.itemId == R.id.action_equalizer) {
            val i = Intent(
    ...
    override fun showTracks(list: ArrayList<AudioTrack>) {
    ...
    fun addTrackInPlaylist(playlistName: String) {
        Toast.makeText(this@MusicListActivity, "Successfully added", Toast.LENGTH_LONG).show()
