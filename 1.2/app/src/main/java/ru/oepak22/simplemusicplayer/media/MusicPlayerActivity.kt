...
class MusicPlayerActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        nextBtn.setOnClickListener {
            ...
            intent.putExtra("order", playListMode)
            if (currentAudioTrack.mStatus == Defines.TRACK_IS_STOPPED)
        ...
        orderBtn.setOnClickListener {
            if (currentAudioTrack.mStatus != Defines.TRACK_IS_STOPPED) {
                ...
                when (playListMode) {
                    Defines.REPEAT_MODE -> {
                        playListMode = Defines.REPEAT_ONE_MODE
                        orderBtn.setImageResource(R.drawable.ic_player_repeat_one_24)
                    }
                    Defines.REPEAT_ONE_MODE -> {
                        playListMode = Defines.RANDOM_MODE
                        orderBtn.setImageResource(R.drawable.ic_player_random_24)
                    }
                    Defines.RANDOM_MODE -> {
                        playListMode = Defines.REPEAT_MODE
                        orderBtn.setImageResource(R.drawable.ic_player_repeat_24)
                    }
                }
            }
        }
